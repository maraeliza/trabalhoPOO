 ...
 * @author Mara
 */
public class Convidado_FamiliaDAO {
    ...
    public static void cadastrar(String nome){
        ...
        if(Convidado_FamiliaDAO.addVetor(recado) == true){
    ...
    public static void atualizar(String idS, String comentario){
        ...
        if(comentario.length() > 1 ){
            if (Convidado_FamiliaDAO.find(id)){
                System.out.println("ITEM ENCONTRADO!");
                Recado recado = Convidado_FamiliaDAO.getItemByID(id);
