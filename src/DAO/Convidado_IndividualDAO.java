 ...
 * @author Mara
 */
public class Convidado_IndividualDAO {
    ...
    public Convidado_IndividualDAO(){
    ...
    public static void cadastrar(String nome){
        ...
        if(Convidado_IndividualDAO.addVetor(recado) == true){
    ...
    public static void atualizar(String idS, String comentario){
        ...
        if(comentario.length() > 1 ){
            if (Convidado_IndividualDAO.find(id)){
                System.out.println("ITEM ENCONTRADO!");
                Recado recado = Convidado_IndividualDAO.getItemByID(id);
